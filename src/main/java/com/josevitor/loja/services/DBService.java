...
import com.josevitor.loja.domain.Pagamento;
import com.josevitor.loja.domain.PagamentoComBoleto;
import com.josevitor.loja.domain.PagamentoComCartao;
import com.josevitor.loja.domain.Pedido;
import com.josevitor.loja.domain.Produto;
import com.josevitor.loja.domain.enums.EstadoPagamento;
import com.josevitor.loja.domain.enums.Perfil;
...
import com.josevitor.loja.repositories.EnderecoRepository;
import com.josevitor.loja.repositories.EstadoRepository;
import com.josevitor.loja.repositories.ItemPedidoRepository;
import com.josevitor.loja.repositories.PagamentoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "freitasjvdev@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "teste@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
